...
export default function TkKurikulum() {
  ...
  const philosophies = [
    {
      ...
      hoverBgMain: "group-hover:bg-emerald-500",
    ...
    },
    {
      ...
      bgMain: "bg-blue-500",
      hoverBgMain: "group-hover:bg-blue-500",
    ...
    },
    {
      ...
      bgMain: "bg-amber-500",
      hoverBgMain: "group-hover:bg-amber-500",
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 md:h-20 flex items-center justify-between min-w-max md:min-w-0">
          ...
          <div className="flex items-center gap-4 md:gap-8 pr-6 md:pr-0">
            <div className="flex space-x-4 md:space-x-8 text-[10px] md:text-[12px] font-bold uppercase tracking-widest whitespace-nowrap">
              <Link href="/unit/tk/kurikulum" className="text-black border-b-[2px] md:border-b-[3px] border-black pb-1">Metode Belajar</Link>
              <Link href="/unit/tk/fasilitas" className="text-black/50 hover:text-black transition-all">Fasilitas</Link>
              <Link href="/unit/tk/ekstrakurikuler" className="text-black/50 hover:text-black transition-all">Ekstrakurikuler</Link>
              <Link href="/unit/tk/pendaftaran" className="text-black/50 hover:text-black transition-all hidden sm:inline">Pendaftaran</Link>
            </div>
